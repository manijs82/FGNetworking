...
public class PlayerController : NetworkBehaviour, IPlayerActions
{
    ...
    public NetworkVariable<bool> canFire = new NetworkVariable<bool>(true); 
    ...
    {
        if (!IsOwner) return;
        if(canMove.Value) _rb.velocity = transform.up * _moveInput.y * movementSpeed;
    ...
    private void LateUpdate()
    {
        ...
        Vector2 currentDirection =
            Vector2.Lerp(turretPivotTransform.up, targetDirection, Time.deltaTime * turretRotationSpeed);
